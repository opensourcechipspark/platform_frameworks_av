...
# 处理生成的状态信息
echo "#define SF_COMPILE_INFO      \"author:  $sf_author time: $sf_date version: ${svn_version:-0}, on Android 4.4.\"" > svn_info.h
echo "#define SF_COMPILE_INFO      \"author:  $sf_author time: $sf_date version: ${svn_version:-0}, on Android 4.4.\"" > ./libvpu/vpu_api/include/svn_info.h
