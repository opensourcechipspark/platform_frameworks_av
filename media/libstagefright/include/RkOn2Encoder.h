...
#ifndef RKON2_ENCODER_H_

#define RKON2_ENCODER_H_
...
struct RkOn2Encoder : public MediaSource,
                    public MediaBufferObserver {
    RkOn2Encoder(const sp<MediaSource> &source,
...
private:
    ...
    RkOn2Encoder(const RkOn2Encoder &);
    RkOn2Encoder &operator=(const RkOn2Encoder &);

};

}  // namespace android

#endif  // RKON2_ENCODER_H_
